								...
								<div className="row">
									...
									<div className="col-6">
										...
										<div className={[InputStyles.pwdFieldWrapper].join(" ")} >
											<input type="password" className={[InputStyles.pwdField].join(" ")} id="password" required placeholder="****"/> <i className="la la-eye-slash "id="mask" onClick={showPwd}></i>
										</div>	
									</div>
									<div className="col-6">
										<label htmlFor="password" className="form-label">Confirm Password</label>
										<div className={[InputStyles.pwdFieldWrapper].join(" ")} >
											<input type="password" className={[InputStyles.pwdField].join(" ")} id="confirm_password" required placeholder="****"/> <i className="la la-eye-slash "id="mask2" onClick={showPwd}></i>
										</div> 
									</div>
