...
import AddAdmin from '../components/ModalAdmin.js'
import EditAdmin from '../components/ModalAdmin.js'
	...
	return(
		<Layout>
			<div className="container contentContainer" >
				<div className="breadcrumbs"><span className="parent">Users Management </span> <i className="las la-angle-right"></i> <span className="child"> All Admin</span></div>
					<StatBox></StatBox>
				{/* End smaller box */}
				<SortAdmin></SortAdmin>
